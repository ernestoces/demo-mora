    ...
    <div class="bg-white pt-[56px] xl:pt-[88px] pb-[188px] px-4">
        ...
        <div class="mt-[56px] xl:flex-row flex flex-col gap-[41px] w-full justify-center">
            <div v-for="article in news"
                class="xl:pr-[41px] pb-[48px] last-of-type:pr-0 last-of-type:border-none xl:border-r-2 border-b-2 border-purple border-opacity-50">
        ...
        <button
            class="font-raleway font-semibold text-base leading-[27px] -tracking-[1%] text-mora border-2 rounded-[3px] p-[8px_22px] border-mora mx-auto block mt-[64px]">Ver
